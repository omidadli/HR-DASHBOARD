          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                <span className="inline-flex items-center gap-1 text-xs font-bold text-brand-700 bg-brand-soft border border-brand-200 px-2 py-0.5 rounded-full tabular-nums">
                  <CheckCircle2 className="w-3.5 h-3.5" />
                  {toPersianDigits(b.stats.interview)}
                </span>
                <span className="inline-flex items-center gap-1 text-xs font-bold text-warning bg-warning-soft border border-[var(--warning-border)] px-2 py-0.5 rounded-full tabular-nums">
                  <Search className="w-3.5 h-3.5" />
                  {toPersianDigits(b.stats.review)}
                </span>
                <span className="inline-flex items-center gap-1 text-xs font-bold text-danger bg-danger-soft border border-[var(--danger-border)] px-2 py-0.5 rounded-full tabular-nums">
